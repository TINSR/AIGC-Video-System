...
const FORBIDDEN_WORDS = [
  { word: '第一', suggestion: '领先、前列、优选' },
  { word: '唯一', suggestion: '独特、少有、特别' },
  { word: '顶级', suggestion: '高端、优质、出色' },
  { word: '最高', suggestion: '较高、出众、出色' },
  { word: '最低', suggestion: '实惠、优惠、高性价比' },
  { word: '最好', suggestion: '优秀、出色、优质' },
  { word: '最佳', suggestion: '理想、合适、优选' },
  { word: '最大', suggestion: '较大、 spacious、大容量' },
  { word: '最小', suggestion: '小巧、便携、迷你' },
  { word: '最全', suggestion: '丰富、全面、多样' },
  { word: '最新', suggestion: '新款、全新、升级' },
  { word: '最先进', suggestion: '先进、前沿、领先技术' },
  { word: '永久', suggestion: '长期、持久、耐用' },
  { word: '100%有效', suggestion: '效果出众、体验良好、多数用户认可' },
  { word: '百分百', suggestion: '高比例、大部分、绝大多数' },
  { word: '绝对', suggestion: '相对、非常、相当' },
  ...
  { word: '特效', suggestion: '有效、效果好、针对性强' },
